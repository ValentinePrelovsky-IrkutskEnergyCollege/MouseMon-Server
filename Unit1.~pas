...
begin
  ...
  begin
    ...
    begin
    ShowMessage('Ётот файл уже есть, дл€ сохранени€ копии выберите другое '+
      'им€ файла или его расположение');
      Exit;
    end;
...
begin
  ShowMessage('ƒанна€ программа-сервер св€зываетс€ с классом клиентов'
  + ' и следит за событием отсоединени€ или присоединени€ мыши к'+
  ' отслеживаемым ѕ .');
end;
